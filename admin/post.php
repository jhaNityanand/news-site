      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-md-12">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                              ...
                              <td class='delete'><a href='delete-post.php?id=<?php echo $row["post_id"]; ?>&catid=<?php echo $row["category"]; ?>' onClick = 'del()'><i class='fa fa-trash-o'></i></a></td>
                          </tr>
                ...
                {
                  /* select query of post table for normal user */
                  $sqlp = "SELECT * FROM post WHERE author = {$_SESSION['user_id']}";
                }
